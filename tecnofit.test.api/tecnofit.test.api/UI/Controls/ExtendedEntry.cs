...
namespace tecnofit.test.api.UI.Controls
{
...

    {
        ...
        public static readonly BindableProperty IsBorderErrorVisibleProperty =
            ...
            BindableProperty.Create(nameof(IsBorderErrorVisible), typeof(bool), typeof(ExtendedEntry), false,
                BindingMode.TwoWay);
        ...
        public static readonly BindableProperty BorderErrorColorProperty =
            ...
            BindableProperty.Create(nameof(BorderErrorColor), typeof(Xamarin.Forms.Color), typeof(ExtendedEntry),
                Xamarin.Forms.Color.Transparent, BindingMode.TwoWay);
